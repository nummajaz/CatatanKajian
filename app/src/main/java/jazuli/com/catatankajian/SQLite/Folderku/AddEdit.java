package jazuli.com.catatankajian.SQLite.Folderku;
...
public class AddEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id = getIntent().getStringExtra(Main3Activity.TAG_ID);
        name = getIntent().getStringExtra(Main3Activity.TAG_NAME);
        address = getIntent().getStringExtra(Main3Activity.TAG_ADDRESS);
